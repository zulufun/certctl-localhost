 ...
 */
import type { GetCertificatesByStatus200StatusCountsItem } from './getCertificatesByStatus200StatusCountsItem';

export type GetCertificatesByStatus200 = {
  status_counts?: GetCertificatesByStatus200StatusCountsItem[];
};
