 ...
 */
import type { ListAuthPermissions200PermissionsItem } from './listAuthPermissions200PermissionsItem';

export type ListAuthPermissions200 = {
  permissions?: ListAuthPermissions200PermissionsItem[];
};
