 ...
 */
import type { RevokeAuthSessionsExceptCurrentExcept } from './revokeAuthSessionsExceptCurrentExcept';

export type RevokeAuthSessionsExceptCurrentParams = {
/**
 * Must be the literal string `current`.
 */
except: RevokeAuthSessionsExceptCurrentExcept;
};
