...
export type ListDiscoveredCertificatesStatus = typeof ListDiscoveredCertificatesStatus[keyof typeof ListDiscoveredCertificatesStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ListDiscoveredCertificatesStatus = {
  Unmanaged: 'Unmanaged',
  Managed: 'Managed',
  Dismissed: 'Dismissed',
} as const;
