 ...
 */
import type { RevokeAuthRolePermissionScopeType } from './revokeAuthRolePermissionScopeType';

export type RevokeAuthRolePermissionParams = {
scope_type?: RevokeAuthRolePermissionScopeType;
scope_id?: string;
};
