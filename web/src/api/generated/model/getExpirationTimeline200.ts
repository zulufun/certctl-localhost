 ...
 */
import type { GetExpirationTimeline200BucketsItem } from './getExpirationTimeline200BucketsItem';

export type GetExpirationTimeline200 = {
  buckets?: GetExpirationTimeline200BucketsItem[];
};
