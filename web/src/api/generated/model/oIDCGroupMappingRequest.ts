...
/**
 * Mirrors internal/api/handler/auth_session_oidc_crud.go::groupMappingRequest. Tenant is derived from the calling actor; not accepted from the request body.
 */
export interface OIDCGroupMappingRequest {
  provider_id: string;
  group_name: string;
  role_id: string;
}
