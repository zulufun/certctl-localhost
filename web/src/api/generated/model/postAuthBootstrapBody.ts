...
export type PostAuthBootstrapBody = {
  /** The CERTCTL_BOOTSTRAP_TOKEN value (constant-time compared server-side). */
  token: string;
  /**
   * 3-64 chars, lowercase alphanumeric + hyphen + underscore.
