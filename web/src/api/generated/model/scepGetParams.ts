 ...
 */
import type { ScepGetOperation } from './scepGetOperation';

export type ScepGetParams = {
/**
 * SCEP operation selector
 */
operation: ScepGetOperation;
/**
 * Optional SCEP message parameter (base64-encoded for GET PKIOperation)
 */
message?: string;
};
