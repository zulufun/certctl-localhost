 ...
 */
import type { GrantAuthRolePermissionBodyScopeType } from './grantAuthRolePermissionBodyScopeType';

export type GrantAuthRolePermissionBody = {
  permission: string;
  scope_type?: GrantAuthRolePermissionBodyScopeType;
  scope_id?: string;
};
