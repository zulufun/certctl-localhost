 ...
 */
import type { GetAuthMe200EffectivePermissionsItemScopeType } from './getAuthMe200EffectivePermissionsItemScopeType';

export type GetAuthMe200EffectivePermissionsItem = {
  permission: string;
