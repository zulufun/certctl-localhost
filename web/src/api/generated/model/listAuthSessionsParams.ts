...
export type ListAuthSessionsParams = {
/**
 * Target actor whose sessions to list. Defaults to the calling actor.
 */
actor_id?: string;
/**
 * Required when `actor_id` is set and differs from the caller's type. Ignored otherwise.
 */
actor_type?: string;
};
