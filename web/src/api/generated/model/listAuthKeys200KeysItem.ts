 ...
 */
import type { ListAuthKeys200KeysItemActorType } from './listAuthKeys200KeysItemActorType';

export type ListAuthKeys200KeysItem = {
  actor_id: string;
  actor_type: ListAuthKeys200KeysItemActorType;
  tenant_id: string;
  role_ids: string[];
};
